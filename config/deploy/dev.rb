...
set :site_url, %w{ncqarc.dev.forumone.com}
...
set :deploy_to, '/var/www/vhosts/ncqarc.dev'
...
role :app, %w{ncqarc@dev.forumone.com}, :primary => true
role :web, %w{ncqarc@dev.forumone.com}
role :db,  %w{ncqarc@dev.forumone.com}
